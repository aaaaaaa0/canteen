...
main_keyboard = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text='Меню')], 
                                              [KeyboardButton(text='Корзина')],
                                              [KeyboardButton(text='Данные для заказа')],],resize_keyboard=True)
...
reconfirm_kb = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="🔄 ИЗМЕНИТЬ", callback_data="edit_contact_info"),
...
edit_fields_kb = InlineKeyboardMarkup(inline_keyboard=[
...
async def menu_sections(menu_section_id=None):
    ...
    for menu_section in all_menu_sections:
        ...
        keyboard.add(InlineKeyboardButton(text=menu_section.name, callback_data=cb_data))
...
async def products(menu_section_id):
    ...
    for product in all_products:
        ...
        keyboard.add(InlineKeyboardButton(text=product.name, callback_data=cb_data))
    keyboard.add(InlineKeyboardButton(text='⬅️', callback_data='to_section_menu'))
